...
public class PlayerWarningEvents {
    ...
    public void onPlayerLoggedIn(PlayerEvent.PlayerLoggedInEvent event) {
        ...
        player.sendSystemMessage(Component.literal("AI requests use your configured OpenRouter account/API key and may cause charges.").withStyle(ChatFormatting.YELLOW));
